                              ...
                              <Container>
                                  <Row>
                                     ...
                                     <Col sm={12} md={6} lg={6} xl={6}>
                                         <div className='d-flex achievements-col'>
                                             <div>
                                                <Image src={projectComplete} className='icons' fluid></Image>
                                             </div>
                                             <div className='ml-3'>
                                     ...
                                     <Col sm={12} md={6} lg={6} xl={6}>
                                         <div className='d-flex achievements-col'>
                                             <div>
                                                <Image src={achievement} className='icons' fluid></Image>
                                             </div>
                                             <div className='ml-3'>
                                     ...
                                     <Col sm={12} md={6} lg={6} xl={6}>
                                         <div className='d-flex achievements-col'>
                                             <div>
                                                <Image src={runningProject} className='icons' fluid></Image>
                                             </div>
                                             <div className='ml-3'>
                                                  <h2 className='text-white'><strong>75+</strong></h2>
